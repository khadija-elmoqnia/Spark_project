...
if __name__ == "__main__":
    ...
    model_path = "file:///C:/Users/Admin/Desktop/spark_project/models/ridge_model"
    
    try:
        # Essayer de charger comme modèle de régression linéaire classique
        model = LinearRegressionModel.load(model_path)
    except Exception as e:
        # Si un modèle de type "LinearRegressionModel" échoue, essayer "GeneralizedLinearRegressionModel"
        print(f"Erreur lors du chargement du modèle LinearRegressionModel : {e}")
        print("Essayer de charger comme GeneralizedLinearRegressionModel...")
        model = GeneralizedLinearRegressionModel.load(model_path)
